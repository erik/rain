...
var _user$project$Model$appendLine = F2(
	function (groups, line) {
		...
		if (_p0.ctor === '[]') {
			...
			var _p2 = _p0._1;
			var _p1 = _p0._0;
			return _elm_lang$core$Native_Utils.eq(_p1.nick, line.nick) ? {
				ctor: '::',
				_0: _elm_lang$core$Native_Utils.update(
					_p1,
					{
						messages: {ctor: '::', _0: line, _1: _p1.messages}
					}),
				_1: _p2
			} : A2(
				_elm_lang$core$List$append,
...
var _user$project$Model$getBuffer = F2(
	function (server, bufferName) {
		return A2(
			...
			_elm_lang$core$String$toLower(bufferName),
			server.buffers);
	});
var _user$project$Model$setBuffer = F3(
	function (server, buf, model) {
		var name_ = _elm_lang$core$String$toLower(buf.name);
		var server_ = function () {
			var buffers = A3(_elm_lang$core$Dict$insert, name_, buf, server.buffers);
			return _elm_lang$core$Native_Utils.update(
				server,
				{buffers: buffers});
		}();
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				servers: A3(_elm_lang$core$Dict$insert, server.meta.name, server_, model.servers)
			});
	});
var _user$project$Model$getServer = F2(
	function (model, serverName) {
...
var _user$project$Model$getActive = function (model) {
	return A2(
		_elm_lang$core$Maybe$andThen,
		_user$project$Model$getServerBuffer(model),
		model.current);
};
var _user$project$Model$getActiveBuffer = function (model) {
	return A2(
		_elm_lang$core$Maybe$map,
		_elm_lang$core$Tuple$second,
		_user$project$Model$getActive(model));
};
var _user$project$Model$getActiveServer = function (model) {
	return A2(
		_elm_lang$core$Maybe$map,
		_elm_lang$core$Tuple$first,
		_user$project$Model$getActive(model));
...
var _user$project$Model$UserInfo = F4(
	function (a, b, c, d) {
		return {nick: a, host: b, real: c, isServer: d};
	});
var _user$project$Model$Buffer = F6(
	function (a, b, c, d, e, f) {
		return {name: a, users: b, topic: c, buffer: d, lastChecked: e, isServer: f};
	});
...
var _user$project$Model$getOrCreateBuffer = F2(
	function (server, bufferName) {
		return A2(
			...
			A2(_user$project$Model$getBuffer, server, bufferName));
	});
			...
			var users = A2(
				...
				_elm_lang$core$Dict$fromList(
					A2(
						_elm_lang$core$List$map,
						function (nick) {
							return {ctor: '_Tuple2', _0: nick, _1: 0};
						},
						nicks)));
			return _elm_lang$core$Native_Utils.update(
				buf,
				{
					users: _user$project$Model$UsersLoaded(users)
				});
		}
	});
...
var _user$project$Irc$parsePrefix = function (prefix) {
	var _p0 = function () {
		var _p1 = A2(_elm_lang$core$String$split, '!', prefix);
		if (((_p1.ctor === '::') && (_p1._1.ctor === '::')) && (_p1._1._1.ctor === '[]')) {
			return {ctor: '_Tuple2', _0: _p1._0, _1: _p1._1._0};
		} else {
			return {ctor: '_Tuple2', _0: '', _1: prefix};
		}
	}();
	var nick = _p0._0;
	var rest = _p0._1;
	var _p2 = function () {
		var _p3 = A2(_elm_lang$core$String$split, '@', rest);
		if (((_p3.ctor === '::') && (_p3._1.ctor === '::')) && (_p3._1._1.ctor === '[]')) {
			return {ctor: '_Tuple2', _0: _p3._0, _1: _p3._1._0};
		} else {
			return {ctor: '_Tuple2', _0: '', _1: rest};
		}
	}();
	var real = _p2._0;
	var host = _p2._1;
	return {
		isServer: _elm_lang$core$Native_Utils.eq(nick, ''),
		nick: nick,
		host: host,
		real: real
	};
};
var _user$project$Irc$parseTimeTag = function (tags) {
	return A2(
		_elm_lang$core$Maybe$map,
		...
		A2(
			...
			function (_p4) {
				return _elm_lang$core$Result$toMaybe(
					_elm_lang$core$Date$fromString(_p4));
			},
			_elm_lang$core$List$head(
				A2(
					_elm_lang$core$List$map,
					_elm_lang$core$String$dropLeft(5),
					A2(
						_elm_lang$core$List$filter,
						_elm_lang$core$String$startsWith('time='),
						A2(_elm_lang$core$String$split, ';', tags))))));
};
var _user$project$Irc$splitMessage = function (line) {
	var command = '(\\w+)\\s+';
	...
	var tag = optional('@(\\w+=\\S+)\\s+');
	var prefix = optional(':(\\S+)\\s+');
	var params = optional('([^:]+)\\s*');
	var lastParam = optional(':(.*?)');
	var messageRegex = _elm_lang$core$Regex$regex(
		_elm_lang$core$String$concat(
			{
				ctor: '::',
				_0: '^',
	...
	var matches = A2(
		...
		A3(_elm_lang$core$Regex$find, _elm_lang$core$Regex$All, messageRegex, line));
	var _p5 = matches;
	if (((((((((_p5.ctor === '::') && (_p5._0.ctor === '::')) && (_p5._0._1.ctor === '::')) && (_p5._0._1._1.ctor === '::')) && (_p5._0._1._1._0.ctor === 'Just')) && (_p5._0._1._1._1.ctor === '::')) && (_p5._0._1._1._1._1.ctor === '::')) && (_p5._0._1._1._1._1._1.ctor === '[]')) && (_p5._1.ctor === '[]')) {
		var splitParams = A2(
			_elm_lang$core$Maybe$withDefault,
			{ctor: '[]'},
			A2(_elm_lang$core$Maybe$map, _elm_lang$core$String$words, _p5._0._1._1._1._0));
		var finalParam = A2(
			_elm_lang$core$Maybe$withDefault,
			{ctor: '[]'},
			A2(
				...
				_p5._0._1._1._1._1._0));
		return _elm_lang$core$Maybe$Just(
			{
				raw: line,
				time: A2(_elm_lang$core$Maybe$andThen, _user$project$Irc$parseTimeTag, _p5._0._0),
				user: _user$project$Irc$parsePrefix(
					A2(_elm_lang$core$Maybe$withDefault, '', _p5._0._1._0)),
				command: _p5._0._1._1._0._0,
				params: A2(_elm_lang$core$List$append, splitParams, finalParam)
			});
	} else {
		var _p6 = A2(_elm_lang$core$Debug$log, 'Failed to parse message', line);
		return _elm_lang$core$Maybe$Nothing;
	}
};
var _user$project$Irc$ParsedMessage = F5(
	function (a, b, c, d, e) {
		return {raw: a, time: b, user: c, command: d, params: e};
	});

var _user$project$Ports$addSavedServer = _elm_lang$core$Native_Platform.incomingPort(
	'addSavedServer',
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (proxyHost) {
															...
															return A2(
																...
																function (saveScrollback) {
																	return _elm_lang$core$Json_Decode$succeed(
																		{proxyHost: proxyHost, proxyPass: proxyPass, server: server, port_: port_, nick: nick, pass: pass, name: name, saveScrollback: saveScrollback});
																},
																A2(_elm_lang$core$Json_Decode$field, 'saveScrollback', _elm_lang$core$Json_Decode$bool));
														},
...
var _user$project$Ports$modifyServerStore = _elm_lang$core$Native_Platform.outgoingPort(
	'modifyServerStore',
	function (v) {
		return [
...
var _user$project$Ports$clearScrollback = _elm_lang$core$Native_Platform.outgoingPort(
	'clearScrollback',
	function (v) {
		return [v._0, v._1];
	});
var _user$project$Ports$requestScrollback = _elm_lang$core$Native_Platform.outgoingPort(
	'requestScrollback',
	function (v) {
		return v;
	});
var _user$project$Ports$saveScrollback = _elm_lang$core$Native_Platform.outgoingPort(
	'saveScrollback',
	function (v) {
		return [
			v._0,
			v._1,
			{ts: v._2.ts, nick: v._2.nick, message: v._2.message}
		];
	});
var _user$project$Ports$sendNotification = _elm_lang$core$Native_Platform.outgoingPort(
	'sendNotification',
	function (v) {
		return [v._0, v._1];
	});
var _user$project$Ports$refreshScrollPosition = _elm_lang$core$Native_Platform.outgoingPort(
	'refreshScrollPosition',
	function (v) {
		return v;
	});

var _user$project$Update$TabCompleteLine = function (a) {
	return {ctor: 'TabCompleteLine', _0: a};
};
var _user$project$Update$StoreServer = {ctor: 'StoreServer'};
var _user$project$Update$SendRawLine = function (a) {
	return {ctor: 'SendRawLine', _0: a};
};
var _user$project$Update$SendLine = F2(
	function (a, b) {
		return {ctor: 'SendLine', _0: a, _1: b};
	});
var _user$project$Update$SelectBuffer = function (a) {
	return {ctor: 'SelectBuffer', _0: a};
};
var _user$project$Update$ReceiveRawLine = function (a) {
	return {ctor: 'ReceiveRawLine', _0: a};
};
var _user$project$Update$RemoveServer = {ctor: 'RemoveServer'};
var _user$project$Update$DisconnectServer = {ctor: 'DisconnectServer'};
var _user$project$Update$CreateBuffer = function (a) {
	return {ctor: 'CreateBuffer', _0: a};
};
var _user$project$Update$ConnectIrc = {ctor: 'ConnectIrc'};
var _user$project$Update$CloseBuffer = function (a) {
	return {ctor: 'CloseBuffer', _0: a};
};
var _user$project$Update$ClearBuffer = function (a) {
	return {ctor: 'ClearBuffer', _0: a};
};
var _user$project$Update$AddScrollback = F2(
	function (a, b) {
		return {ctor: 'AddScrollback', _0: a, _1: b};
	});
var _user$project$Update$AddLine = F2(
	function (a, b) {
		return {ctor: 'AddLine', _0: a, _1: b};
	});
var _user$project$Update$Noop = {ctor: 'Noop'};
var _user$project$Update$TypeLine = function (a) {
	return {ctor: 'TypeLine', _0: a};
};
var _user$project$Update$Tick = function (a) {
	return {ctor: 'Tick', _0: a};
};
var _user$project$Update$ShowAddServerForm = {ctor: 'ShowAddServerForm'};
var _user$project$Update$SendNotification = F2(
	function (a, b) {
		return {ctor: 'SendNotification', _0: a, _1: b};
	});
var _user$project$Update$RefreshScroll = function (a) {
	return {ctor: 'RefreshScroll', _0: a};
};
var _user$project$Update$MultiMsg = function (a) {
	return {ctor: 'MultiMsg', _0: a};
};
var _user$project$Update$FormMsg = function (a) {
	return {ctor: 'FormMsg', _0: a};
};
var _user$project$Update$AddServer = function (a) {
	return {ctor: 'AddServer', _0: a};
};
var _user$project$Update$ModifyServer = F2(
	function (a, b) {
		return {ctor: 'ModifyServer', _0: a, _1: b};
	});
var _user$project$Update$modifyServer = F2(
	function (server, msg) {
		return A2(_user$project$Update$ModifyServer, server.meta.name, msg);
	});
var _user$project$Update$sendLine = F4(
	function (server, buf, line, model) {
		var addErrorMessage = function (msg) {
			...
			return {
				...
				_0: A2(
					...
					server,
					A2(_user$project$Update$AddLine, buf.name, line)),
				_1: {ctor: '[]'}
			};
		};
		var commandAliases = function (cmd) {
			return A2(
				_elm_lang$core$Maybe$withDefault,
				cmd,
				A2(
					...
					_elm_lang$core$Dict$fromList(
						{
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: '/j', _1: '/join'},
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: '/msg', _1: '/privmsg'},
								_1: {
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: '/pm', _1: '/privmsg'},
									_1: {
										ctor: '::',
				...
				var rawLine = A2(
					...
					' ',
					{
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: A2(_elm_lang$core$Basics_ops['++'], ':', msg),
								_1: {ctor: '[]'}
							}
						}
					});
				var line = {ts: model.currentTime, nick: server.meta.nick, message: msg};
				return buf.isServer ? addErrorMessage('use /quote to send messages directly to the server') : {
					ctor: '::',
					_0: A2(
						_user$project$Update$modifyServer,
						server,
						_user$project$Update$SendRawLine(rawLine)),
					_1: {
						ctor: '::',
						_0: A2(
							_user$project$Update$modifyServer,
							server,
							A2(_user$project$Update$AddLine, target, line)),
						_1: {
							ctor: '::',
							_0: server.meta.saveScrollback ? A2(
								_user$project$Update$modifyServer,
								server,
								A2(_user$project$Update$AddScrollback, target, line)) : _user$project$Update$Noop,
							_1: {ctor: '[]'}
						}
					}
				};
		...
		var ctcp = F3(
			function (target, command, msg) {
				var msg_ = _elm_lang$core$String$concat(
					{
						ctor: '::',
						_0: '',
						_1: {
						...
						if (_p0.ctor === '_Tuple2') {
							switch (_p0._0) {
								case '/join':
									if ((_p0._1.ctor === '::') && (_p0._1._1.ctor === '[]')) {
										...
										return A2(_elm_lang$core$String$startsWith, '#', _p1) ? A2(
											...
											{
												ctor: '::',
												_0: _user$project$Update$SendRawLine(
													A2(_elm_lang$core$Basics_ops['++'], 'JOIN ', _p1)),
												_1: {
													ctor: '::',
													_0: _user$project$Update$SelectBuffer(_p1),
													_1: {ctor: '[]'}
												}
									...
									if ((_p0._1.ctor === '::') && (_p0._1._1.ctor === '[]')) {
										...
										return A2(_elm_lang$core$String$startsWith, '#', _p2) ? addErrorMessage('can only initiate queries with users') : {
											...
											_0: A2(
												_user$project$Update$modifyServer,
												server,
												_user$project$Update$SelectBuffer(_p2)),
											_1: {ctor: '[]'}
										};
									} else {
										break _v0_16;
											...
											return {
												...
												_0: A2(
													...
													_user$project$Update$SendRawLine(
														A2(_elm_lang$core$Basics_ops['++'], 'PART ', _p3))),
												_1: {
													ctor: '::',
													_0: A2(
														_user$project$Update$modifyServer,
														server,
														_user$project$Update$CloseBuffer(_p3)),
													_1: {ctor: '[]'}
												}
											};
										} else {
								...
								case '/me':
									...
									return A3(ctcp, buf.name, 'ACTION', msg);
								case '/privmsg':
									if (_p0._1.ctor === '::') {
										return A2(
											privmsg,
									...
									if ((_p0._1.ctor === '::') && (_p0._1._1.ctor === '[]')) {
										switch (_p0._1._0) {
											case 'save':
												return {
													ctor: '::',
													_0: A2(_user$project$Update$modifyServer, server, _user$project$Update$StoreServer),
													_1: {ctor: '[]'}
												};
											case 'delete':
												return {
		...
		var _p5 = {
			ctor: '_Tuple2',
			_0: A2(_elm_lang$core$String$left, 1, line),
			_1: _elm_lang$core$String$words(line)
		};
		if (((_p5.ctor === '_Tuple2') && (_p5._0 === '/')) && (_p5._1.ctor === '::')) {
			return A2(
				slashCommand,
				commandAliases(_p5._1._0),
				_p5._1._1);
		} else {
			return A2(privmsg, buf.name, line);
		}
	});
var _user$project$Update$updateServer = F3(
	function (server, msg, model) {
		var _p6 = msg;
		switch (_p6.ctor) {
			case 'AddLine':
				var _p8 = _p6._1;
				var _p7 = _p6._0;
				var body = _elm_lang$core$String$concat(
					{
						ctor: '::',
						_0: '<',
						_1: {
				...
				var isDirectMessage = (!_elm_lang$core$Native_Utils.eq(server.meta.nick, _p8.nick)) && (!A2(_elm_lang$core$String$startsWith, '#', _p7));
				var nickRegexp = _elm_lang$core$Regex$regex(
					A2(
						_elm_lang$core$Basics_ops['++'],
						'\\b',
						A2(_elm_lang$core$Basics_ops['++'], server.meta.nick, '\\b')));
				var matchesNick = A2(_elm_lang$core$Regex$contains, nickRegexp, _p8.message);
				var buf = function (b) {
					return _elm_lang$core$Native_Utils.update(
						b,
						{
							buffer: A2(_user$project$Model$appendLine, b.buffer, _p8)
						});
				}(
					A2(_user$project$Model$getOrCreateBuffer, server, _p7));
				var model_ = A3(_user$project$Model$setBuffer, server, buf, model);
				var cmd = ((!buf.isServer) && (matchesNick || isDirectMessage)) ? A2(_user$project$Update$SendNotification, buf.name, body) : _user$project$Update$Noop;
				return A2(_user$project$Update$update, cmd, model_);
			case 'AddScrollback':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					model,
					{
						...
						_0: _user$project$Ports$saveScrollback(
							{ctor: '_Tuple3', _0: server.meta.name, _1: _p6._0, _2: _p6._1}),
						_1: {ctor: '[]'}
					});
			case 'ClearBuffer':
				var _p10 = _p6._0;
				var _p9 = A2(_user$project$Model$getBuffer, server, _p10);
				if (_p9.ctor === 'Just') {
					...
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						A3(_user$project$Model$setBuffer, server, buffer_, model),
						{
							ctor: '::',
							_0: _user$project$Ports$clearScrollback(
								{ctor: '_Tuple2', _0: server.meta.name, _1: _p10}),
							_1: {ctor: '[]'}
						});
				} else {
					return A2(
				...
				var server_ = _elm_lang$core$Native_Utils.update(
					server,
					{
						buffers: A2(
							...
							_elm_lang$core$String$toLower(_p11),
							server.buffers)
					});
				var current = _elm_lang$core$Native_Utils.eq(
					model.current,
					_elm_lang$core$Maybe$Just(
						{ctor: '_Tuple2', _0: server.meta.name, _1: _p11})) ? _elm_lang$core$Maybe$Nothing : model.current;
			...
			case 'ConnectIrc':
				var passMsg = A2(
					...
					A2(
						_elm_lang$core$Maybe$map,
						function (pass) {
							return A2(_elm_lang$core$Basics_ops['++'], 'PASS ', pass);
						},
						server.pass));
				var lines = {
					ctor: '::',
					...
					_1: {
						ctor: '::',
						_0: 'CAP REQ znc.in/server-time-iso',
						_1: {
							ctor: '::',
							_0: 'CAP REQ server-time',
							_1: {
								ctor: '::',
								_0: 'CAP END',
								_1: {
									ctor: '::',
									_0: A2(_elm_lang$core$Basics_ops['++'], 'NICK ', server.meta.nick),
									_1: {
										ctor: '::',
										_0: A2(
											_elm_lang$core$Basics_ops['++'],
											...
											A2(
												_elm_lang$core$Basics_ops['++'],
												server.meta.nick,
												A2(_elm_lang$core$Basics_ops['++'], ' * * :', server.meta.nick))),
										_1: {ctor: '[]'}
									}
								}
							}
				...
				return A3(
					...
					_user$project$Update$batchMessage,
					model,
					A2(
						_elm_lang$core$List$map,
						function (line) {
							return A2(
								_user$project$Update$modifyServer,
								server,
								_user$project$Update$SendRawLine(line));
						},
						lines));
			case 'CreateBuffer':
				var buffer = _user$project$Model$newBuffer(_p6._0);
				var model_ = A3(_user$project$Model$setBuffer, server, buffer, model);
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					model_,
					{ctor: '[]'});
			case 'DisconnectServer':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							servers: A2(_elm_lang$core$Dict$remove, server.meta.name, model.servers)
						}),
					{ctor: '[]'});
			case 'RemoveServer':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$Ports$modifyServerStore(
						{ctor: '_Tuple2', _0: server.meta, _1: 'REMOVE'})
				};
			case 'ReceiveRawLine':
				var _p12 = _p6._0;
				var getTs = function (msg) {
					return A2(_elm_lang$core$Maybe$withDefault, model.currentTime, msg.time);
				};
				return _elm_lang$core$Native_Utils.eq(_p12, 'AUTHENTICATE') ? A2(
					_user$project$Update$update,
					A2(_user$project$Update$modifyServer, server, _user$project$Update$ConnectIrc),
					model) : A2(
					_elm_lang$core$Maybe$withDefault,
					...
					A2(
						...
						function (msg) {
							return A4(
								_user$project$Update$handleCommand,
								server,
								getTs(msg),
								msg,
								model);
						},
						_user$project$Irc$splitMessage(_p12)));
			case 'SelectBuffer':
				var _p13 = _p6._0;
				var buffer = function (chan) {
					...
					A2(_user$project$Model$getOrCreateBuffer, server, _p13));
				var model_ = function (model) {
					return _elm_lang$core$Native_Utils.update(
						model,
						{
							current: _elm_lang$core$Maybe$Just(
								{ctor: '_Tuple2', _0: server.meta.name, _1: _p13}),
							newServerForm: _elm_lang$core$Maybe$Nothing
						});
				}(
					A3(_user$project$Model$setBuffer, server, buffer, model));
				return A2(
					_user$project$Update$update,
					_user$project$Update$RefreshScroll(true),
					model_);
			case 'StoreServer':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$Ports$modifyServerStore(
						{ctor: '_Tuple2', _0: server.meta, _1: 'STORE'})
				};
			case 'SendLine':
				return _elm_lang$core$Native_Utils.eq(model.inputLine, '') ? A2(
					...
					A2(
						_user$project$Update$batchMessage,
						A4(_user$project$Update$sendLine, server, _p6._0, _p6._1, model),
						_elm_lang$core$Native_Utils.update(
							model,
							{inputLine: ''})));
			case 'SendRawLine':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: A2(_elm_lang$websocket$WebSocket$send, server.socket, _p6._0)
				};
			default:
				var words = A2(_elm_lang$core$String$split, ' ', model.inputLine);
				var lastWord = function () {
					var _p14 = _elm_lang$core$List$head(
						_elm_lang$core$List$reverse(words));
					if ((_p14.ctor === 'Just') && (_p14._0 === '')) {
						return _elm_lang$core$Maybe$Nothing;
					} else {
						return _p14;
					}
				...
				var completion = A2(
					...
					A2(
						...
						_elm_lang$core$List$filter(
							function (nick) {
								return !_elm_lang$core$Native_Utils.eq(nick, server.meta.nick);
							}),
						A2(
							_elm_lang$core$Maybe$map,
							function (word) {
								var _p15 = _p6._0.users;
								if (_p15.ctor === 'UsersLoading') {
									return _elm_lang$core$List$sort(
										A2(
											_elm_lang$core$List$filter,
											_elm_lang$core$String$startsWith(word),
											_p15._0));
								} else {
									return A2(
										_elm_lang$core$List$map,
										...
										A2(
											...
											_elm_lang$core$Dict$toList(
												A2(
													...
													F2(
														function (nick, _p18) {
															return A2(_elm_lang$core$String$startsWith, word, nick);
														}),
													_p15._0))));
								}
							},
				...
				var inputLine = function () {
					...
					if (_p19.ctor === 'Just') {
						...
						if ((_p20.ctor === '::') && (_p20._1.ctor === '[]')) {
							return A2(_elm_lang$core$Basics_ops['++'], _p22, ': ');
						} else {
							var _p21 = _p20;
							return A2(
								_elm_lang$core$String$join,
								...
								A2(
									...
									A2(
										...
										_elm_lang$core$List$length(_p21) - 1,
										_p21),
									{
										ctor: '::',
										_0: _p22,
...
var _user$project$Update$andThen = F2(
	function (msg, _p23) {
		var _p24 = _p23;
		var _p25 = A2(_user$project$Update$update, msg, _p24._0);
		...
		while (true) {
			...
			switch (_p26.ctor) {
				case 'ModifyServer':
					var _p29 = _p26._0;
					var _p28 = _p26._1;
					var _p27 = A2(_user$project$Model$getServer, model, _p29);
					if (_p27.ctor === 'Just') {
						return A3(_user$project$Update$updateServer, _p27._0, _p28, model);
					} else {
						return A2(
							_elm_lang$core$Native_Utils.crash(
								'Update',
				...
				case 'AddServer':
					var _p32 = _p26._0;
					var pass = _elm_lang$core$Native_Utils.eq(_p32.pass, '') ? _elm_lang$core$Maybe$Nothing : _elm_lang$core$Maybe$Just(_p32.pass);
					var queryString = A2(
						_elm_lang$core$String$join,
						'&',
						A2(
							...
							function (_p30) {
								...
								return A2(
									...
									A2(
										_elm_lang$core$Basics_ops['++'],
										'=',
										_elm_lang$http$Http$encodeUri(_p31._1)));
							},
							{
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'host', _1: _p32.server},
								_1: {
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: 'port', _1: _p32.port_},
									_1: {
										ctor: '::',
										_0: {ctor: '_Tuple2', _0: 'proxyPass', _1: _p32.proxyPass},
										_1: {
											ctor: '::',
											_0: {ctor: '_Tuple2', _0: 'name', _1: _p32.name},
											_1: {ctor: '[]'}
										}
									}
								}
							}));
					var socketUrl = _elm_lang$core$String$concat(
						{
							ctor: '::',
							_0: _p32.proxyHost,
							_1: {
					...
					var server = {socket: socketUrl, pass: pass, meta: _p32, buffers: _elm_lang$core$Dict$empty};
					var servers_ = A3(_elm_lang$core$Dict$insert, _p32.name, server, model.servers);
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_elm_lang$core$Native_Utils.update(
							model,
				...
				case 'RefreshScroll':
					return {
						ctor: '_Tuple2',
						_0: model,
						_1: _user$project$Ports$refreshScrollPosition(_p26._0)
					};
				case 'SendNotification':
					return {
						ctor: '_Tuple2',
						_0: model,
						_1: _user$project$Ports$sendNotification(
							{ctor: '_Tuple2', _0: _p26._0, _1: _p26._1})
					};
				case 'Tick':
					var _p34 = _p26._0;
					var model_ = function () {
						var _p33 = _user$project$Model$getActive(model);
						if (_p33.ctor === 'Just') {
							return A3(
				...
				case 'FormMsg':
					...
					var _p35 = {ctor: '_Tuple2', _0: _p36, _1: serverMeta};
					if (((_p35.ctor === '_Tuple2') && (_p35._0.ctor === 'Submit')) && (_p35._1.ctor === 'Just')) {
						var _v18 = _user$project$Update$AddServer(_p35._1._0),
						...
						return A2(
							...
							_elm_lang$core$Native_Utils.update(
								model,
								{
									newServerForm: A2(
										_elm_lang$core$Maybe$map,
										A2(_etaque$elm_form$Form$update, _user$project$Model$newServerValidation, _p36),
										form_)
								}),
							{ctor: '[]'});
					}
				case 'ShowAddServerForm':
					var form = A2(
						...
						{ctor: '[]'},
						_user$project$Model$newServerValidation);
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_elm_lang$core$Native_Utils.update(
							model,
							{
								newServerForm: _elm_lang$core$Maybe$Just(form)
							}),
						{ctor: '[]'});
				case 'MultiMsg':
					return A2(_user$project$Update$batchMessage, _p26._0, model);
				default:
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			}
		}
	});
var _user$project$Update$batchMessage = F2(
	function (msgs, model) {
		return A3(
			_elm_lang$core$List$foldr,
			_user$project$Update$andThen,
...
var _user$project$Update$handleCommand = F4(
	function (server, ts, msg, model) {
		var _p37 = {ctor: '_Tuple2', _0: msg.command, _1: msg.params};
		_v20_13:
		do {
				...
				switch (_p37._0) {
					case '001':
						...
						var server_ = _elm_lang$core$Native_Utils.update(
							server,
							{buffers: buffers_});
						var model_ = function (servers) {
							return _elm_lang$core$Native_Utils.update(
								model,
								{servers: servers});
						}(
							A3(_elm_lang$core$Dict$insert, server.meta.name, server_, model.servers));
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							model_,
							{
								ctor: '::',
								_0: _user$project$Ports$requestScrollback(server.meta.name),
								_1: {ctor: '[]'}
							});
					case 'PING':
						var pong = A2(
							_elm_lang$core$Basics_ops['++'],
							'PONG ',
							_elm_lang$core$String$concat(_p37._1));
						return A3(
							_user$project$Update$updateServer,
							server,
							_user$project$Update$SendRawLine(pong),
							model);
					case 'JOIN':
						if ((_p37._1.ctor === '::') && (_p37._1._1.ctor === '[]')) {
							var _p39 = _p37._1._0;
							var buffer = A2(
								...
								A2(
									_elm_lang$core$Maybe$withDefault,
									_user$project$Model$newBuffer(_p39),
									A2(_user$project$Model$getBuffer, server, _p39)));
							var weJoined = _elm_lang$core$Native_Utils.eq(server.meta.nick, msg.user.nick);
							...
							var current_ = (weJoined && _elm_lang$core$Native_Utils.eq(model.current, _elm_lang$core$Maybe$Nothing)) ? _elm_lang$core$Maybe$Just(
								{ctor: '_Tuple2', _0: server.meta.name, _1: buffer.name}) : model.current;
							return A2(
								_elm_lang$core$Platform_Cmd_ops['!'],
								_elm_lang$core$Native_Utils.update(
									model_,
					...
					case 'PART':
						if (_p37._1.ctor === '::') {
							var _p43 = _p37._1._0;
							var _p40 = A2(_user$project$Model$getBuffer, server, _p43);
							if (_p40.ctor === 'Just') {
								var _p41 = _elm_lang$core$Native_Utils.eq(server.meta.nick, msg.user.nick) ? {
									ctor: '_Tuple2',
									_0: _elm_lang$core$Maybe$Nothing,
									_1: A2(
										_user$project$Update$modifyServer,
										server,
										_user$project$Update$CloseBuffer(_p43))
								} : {ctor: '_Tuple2', _0: model.current, _1: _user$project$Update$Noop};
								var current = _p41._0;
								var cmd = _p41._1;
								var buf_ = A2(_user$project$Model$removeNick, msg.user.nick, _p40._0);
								var model_ = A3(_user$project$Model$setBuffer, server, buf_, model);
								return A2(
									_user$project$Update$update,
									cmd,
									_elm_lang$core$Native_Utils.update(
								...
								var _p42 = A2(_elm_lang$core$Debug$log, 'odd: PART for channel we aren\'t in.', _p43);
								return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
							}
						} else {
							break _v20_13;
					...
					case 'QUIT':
						var model_ = _elm_lang$core$Native_Utils.update(
							model,
							{
								servers: A3(_elm_lang$core$Dict$insert, server.meta.name, server, model.servers)
							});
					...
					case 'PRIVMSG':
						if (((_p37._1.ctor === '::') && (_p37._1._1.ctor === '::')) && (_p37._1._1._1.ctor === '[]')) {
							return A6(_user$project$Update$handleMessage, server, msg.user, _p37._1._0, _p37._1._1._0, ts, model);
						} else {
							break _v20_13;
						}
					case 'NOTICE':
						if (((_p37._1.ctor === '::') && (_p37._1._1.ctor === '::')) && (_p37._1._1._1.ctor === '[]')) {
							var _p46 = _p37._1._1._0;
							var formatCtcp = function (msg) {
								var _p45 = _elm_lang$core$String$words(msg);
								if ((((_p45.ctor === '::') && (_p45._0 === 'PING')) && (_p45._1.ctor === '::')) && (_p45._1._1.ctor === '[]')) {
									var time = A2(
										_elm_lang$core$Result$withDefault,
										0,
										_elm_lang$core$String$toFloat(_p45._1._0));
									var pingTime = _elm_lang$core$Basics$toString(
										_elm_lang$core$Time$inSeconds(model.currentTime - time));
									return A2(
										_elm_lang$core$Basics_ops['++'],
										'PONG: ',
										A2(_elm_lang$core$Basics_ops['++'], pingTime, ' secs'));
								} else {
									return A2(_elm_lang$core$Basics_ops['++'], 'CTCP:', msg);
								}
							};
							var notice = A2(_elm_lang$core$String$startsWith, '', _p46) ? formatCtcp(
								_elm_lang$core$String$concat(
									A2(_elm_lang$core$String$split, '', _p46))) : A2(_elm_lang$core$Basics_ops['++'], 'NOTICE: ', _p46);
							return A6(_user$project$Update$handleMessage, server, msg.user, _p37._1._0, notice, ts, model);
						} else {
							break _v20_13;
						}
					case '306':
						return A2(
							...
							{ctor: '[]'});
					case '332':
						if ((((_p37._1.ctor === '::') && (_p37._1._1.ctor === '::')) && (_p37._1._1._1.ctor === '::')) && (_p37._1._1._1._1.ctor === '[]')) {
							var buf = A2(_user$project$Model$getOrCreateBuffer, server, _p37._1._1._0);
							var buf_ = _elm_lang$core$Native_Utils.update(
								buf,
								{
									topic: _elm_lang$core$Maybe$Just(_p37._1._1._1._0)
								});
							return {
								ctor: '_Tuple2',
								_0: A3(_user$project$Model$setBuffer, server, buf_, model),
								_1: _elm_lang$core$Platform_Cmd$none
							};
						} else {
							break _v20_13;
					...
					case '333':
						return A2(
							...
							{ctor: '[]'});
					case '353':
						if (((((_p37._1.ctor === '::') && (_p37._1._1.ctor === '::')) && (_p37._1._1._1.ctor === '::')) && (_p37._1._1._1._1.ctor === '::')) && (_p37._1._1._1._1._1.ctor === '[]')) {
							...
							var userList = _elm_lang$core$String$words(
								stripSpecial(_p37._1._1._1._1._0));
							var buf = A2(
								_user$project$Model$addNicks,
								userList,
								A2(_user$project$Model$getOrCreateBuffer, server, _p37._1._1._1._0));
							var model_ = A3(_user$project$Model$setBuffer, server, buf, model);
							return A2(
								_elm_lang$core$Platform_Cmd_ops['!'],
								model_,
					...
					case '366':
						if ((((_p37._1.ctor === '::') && (_p37._1._1.ctor === '::')) && (_p37._1._1._1.ctor === '::')) && (_p37._1._1._1._1.ctor === '[]')) {
							var _p52 = _p37._1._1._0;
							var _p48 = A2(_user$project$Model$getBuffer, server, _p52);
							if (_p48.ctor === 'Just') {
								var _p50 = _p48._0;
								var users = function () {
									var _p49 = _p50.users;
									if (_p49.ctor === 'UsersLoading') {
								...
								var _p51 = A2(_elm_lang$core$Debug$log, 'weird: 366 for unknown channel', _p52);
								return A2(
									_elm_lang$core$Platform_Cmd_ops['!'],
									model,
									{ctor: '[]'});
					...
					case 'NICK':
						if ((_p37._1.ctor === '::') && (_p37._1._1.ctor === '[]')) {
							var myNick = _elm_lang$core$Native_Utils.eq(msg.user.nick, server.meta.nick) ? _p37._1._0 : server.meta.nick;
		...
		var _p53 = A2(_elm_lang$core$Debug$log, 'unknown msg', msg);
		...
		return A2(
			_user$project$Update$update,
			_user$project$Update$MultiMsg(
				{
					ctor: '::',
					_0: A2(
						_user$project$Update$modifyServer,
						server,
						A2(_user$project$Update$AddLine, _user$project$Model$serverBufferName, newLine)),
					_1: {
						ctor: '::',
						_0: _user$project$Update$RefreshScroll(false),
						_1: {ctor: '[]'}
					}
				}),
			model);
...
var _user$project$Update$handleMessage = F6(
	function (server, user, target, message, ts, model) {
		var colorCodeRegex = _elm_lang$core$Regex$regex('\\d{2}(?:,\\d{2})?');
		var stripped = A4(
			_elm_lang$core$Regex$replace,
			_elm_lang$core$Regex$All,
			colorCodeRegex,
			...
			message);
		var nick = user.isServer ? server.meta.name : user.nick;
		var newLine = {ts: ts, nick: nick, message: stripped};
		var model_ = (!user.isServer) ? A2(
			_elm_lang$core$Maybe$withDefault,
			model,
			A2(
				_elm_lang$core$Maybe$map,
				function (buf) {
					return A3(_user$project$Model$setBuffer, server, buf, model);
				},
				A2(
					_elm_lang$core$Maybe$map,
		...
		var newMsg = A2(
			_user$project$Update$modifyServer,
			server,
			A2(_user$project$Update$AddLine, target_, newLine));
		var refreshMsg = _elm_lang$core$Native_Utils.eq(
			_elm_lang$core$Maybe$Just(
				{ctor: '_Tuple2', _0: server.meta.name, _1: target_}),
			model.current) ? _user$project$Update$RefreshScroll(false) : _user$project$Update$Noop;
		var scrollbackMsg = ((!user.isServer) && server.meta.saveScrollback) ? A2(
			_user$project$Update$modifyServer,
			server,
			A2(_user$project$Update$AddScrollback, target_, newLine)) : _user$project$Update$Noop;
		return A2(
			_user$project$Update$update,
			_user$project$Update$MultiMsg(
				{
...
var _user$project$View$formatLine = F2(
	function (nick, line) {
		var copyText = A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('copy-text'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text(
					A2(
						_elm_lang$core$Basics_ops['++'],
						'<',
						A2(_elm_lang$core$Basics_ops['++'], line.nick, '> '))),
				_1: {ctor: '[]'}
			});
		var matchesNick = A2(
		...
		var timeStr = A2(
			...
			'%Y-%m-%d %H:%M:%S',
			_elm_lang$core$Date$fromTime(line.ts));
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$title(timeStr),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$classList(
						{
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'highlight', _1: matchesNick},
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'action', _1: isAction},
								_1: {ctor: '[]'}
							}
						}),
					_1: {ctor: '[]'}
...
var _user$project$View$viewLineGroup = F2(
	function (serverMeta, group) {
		...
		var timeStr = A2(
			_mgold$elm_date_format$Date_Format$format,
			'%H:%M:%S',
			_elm_lang$core$Date$fromTime(group.ts));
		var groupHead = A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('group-head'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(timeStr),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
						...
						_0: A2(
							_elm_lang$html$Html$div,
							{
								...
								_0: _elm_lang$html$Html_Attributes$classList(
									{
										ctor: '::',
										_0: {ctor: '_Tuple2', _0: 'message-nick', _1: true},
										_1: {
											ctor: '::',
											_0: {
												ctor: '_Tuple2',
										...
										_1: {
											...
											_0: _elm_lang$html$Html_Events$onClick(
												A2(
													_user$project$Update$ModifyServer,
													serverMeta.name,
													_user$project$Update$SelectBuffer(group.nick))),
											_1: {ctor: '[]'}
										}
									},
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text(group.nick),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}),
...
var _user$project$View$viewTopic = function (buffer) {
	...
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$id('buffer-topic'),
			_1: {ctor: '[]'}
		},
		_user$project$View$linkifyLine(topic));
};
var _user$project$View$tabKey = 9;
var _user$project$View$enterKey = 13;
var _user$project$View$onInputKey = F3(
	function (model, server, buffer) {
		var options = {stopPropagation: false, preventDefault: true};
		var isKey = function (code) {
			return _elm_lang$core$Native_Utils.eq(code, _user$project$View$enterKey) ? _elm_lang$core$Json_Decode$succeed(
				A2(
					_user$project$Update$ModifyServer,
					server.meta.name,
					A2(_user$project$Update$SendLine, buffer, model.inputLine))) : (_elm_lang$core$Native_Utils.eq(code, _user$project$View$tabKey) ? _elm_lang$core$Json_Decode$succeed(
				A2(
					_user$project$Update$ModifyServer,
					server.meta.name,
					_user$project$Update$TabCompleteLine(buffer))) : _elm_lang$core$Json_Decode$fail('nope'));
		};
		return A3(
			_elm_lang$html$Html_Events$onWithOptions,
			'keydown',
...
var _user$project$View$viewBuffer = F3(
	function (model, server, buffer) {
		...
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$id('buffer-view'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$id('buffer-header'),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('flex-fixed'),
							_1: {ctor: '[]'}
						}
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(bufferName),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: _user$project$View$viewTopic(buffer),
							_1: {ctor: '[]'}
						}
					}),
				_1: {
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$id('buffer-footer'),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('flex-fixed'),
									_1: {ctor: '[]'}
									...
									_elm_lang$html$Html$input,
									{
										...
										_1: {
											...
											_1: {
												...
												_1: {
													ctor: '::',
													_0: A3(_user$project$View$onInputKey, model, server, buffer),
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$value(model.inputLine),
														_1: {
															ctor: '::',
...
var _user$project$View$hasUnread = function (buf) {
	var lastMessageTs = A2(
		_elm_lang$core$Maybe$withDefault,
		buf.lastChecked,
		A2(
			_elm_lang$core$Maybe$map,
...
var _user$project$View$viewBufferList = function (model) {
	var addServer = A2(
		_elm_lang$html$Html$li,
		{
			...
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onClick(_user$project$Update$ShowAddServerForm),
				_1: {ctor: '[]'}
			}
		},
		{
				...
				_elm_lang$html$Html$li,
				{
					...
					_0: _elm_lang$html$Html_Events$onClick(
						A2(
							_user$project$Update$ModifyServer,
							serverName,
							_user$project$Update$SelectBuffer(buf.name))),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$classList(
							{
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'clickable', _1: true},
								_1: {
									ctor: '::',
									_0: {
										ctor: '_Tuple2',
										_0: 'unread',
										_1: _user$project$View$hasUnread(buf)
									},
									_1: {
										ctor: '::',
	...
	var bufferList = function (server) {
		return A2(
			_elm_lang$core$List$map,
			viewBuf(server.meta.name),
			A2(
				_elm_lang$core$List$sortBy,
				function (_) {
					return _.name;
				...
				A2(
					...
					_elm_lang$core$Dict$values(server.buffers))));
	};
	var serverList = A2(
		_elm_lang$core$List$map,
		function (_p2) {
		...
		_elm_lang$core$Dict$toList(model.servers));
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$id('buffer-list'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				_elm_lang$html$Html$ul,
				{ctor: '[]'},
				{ctor: '::', _0: addServer, _1: serverList}),
			_1: {ctor: '[]'}
		});
};
var _user$project$View$viewForm = function (form) {
	var scrollbackInput = A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Save scrollback'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					_etaque$elm_form$Form_Input$checkboxInput,
					A2(_etaque$elm_form$Form$getFieldAsBool, 'saveScrollback', form),
					{ctor: '[]'}),
				_1: {ctor: '[]'}
			}
		});
	var inputs = {
		ctor: '::',
		_0: {ctor: '_Tuple4', _0: _etaque$elm_form$Form_Input$textInput, _1: 'WebSocket proxy:', _2: 'proxyHost', _3: 'wss://rain-proxy.example.com/'},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple4', _0: _etaque$elm_form$Form_Input$passwordInput, _1: 'WebSocket proxy password:', _2: 'proxyPass', _3: ''},
			_1: {
				ctor: '::',
				...
				_1: {
					...
					_1: {
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple4', _0: _etaque$elm_form$Form_Input$textInput, _1: 'Nick', _2: 'nick', _3: 'rain`'},
								_1: {ctor: '[]'}
							}
						}
					}
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Add IRC Connection'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
					...
					_0: A2(
						...
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onClick(_etaque$elm_form$Form$Submit),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
...
var _user$project$View$viewHelpText = function () {
	var setupSteps = A2(
		...
		A2(
			...
			{
				ctor: '::',
				_0: 'start websocket proxy',
				_1: {
					ctor: '::',
					_0: 'configure irc connection through \'add server\' dialog',
					_1: {
						ctor: '::',
						_0: 'if everything connects correctly, \'/server save\' to\n                 persist the server config to localStorage',
						_1: {
							ctor: '::',
							_0: '☔ ',
							_1: {ctor: '[]'}
	...
	var commandDesc = {
		...
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: '/server delete', _1: 'remove the current configuration from localstorage'},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: '/server disconnect', _1: 'close the IRC connection to the current server'},
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: '/join #channel', _1: 'join and switch to #channel'},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: '/part', _1: 'leave the current channel'},
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: '/part #channel', _1: 'leave #channel'},
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: '/close', _1: 'close the current buffer window'},
								_1: {
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: '/clear', _1: 'clear out the contents of the current buffer window'},
									_1: {
										ctor: '::',
										_0: {ctor: '_Tuple2', _0: '/ping nick', _1: 'send CTCP PING to nick'},
										_1: {
											ctor: '::',
				...
				return A2(
					...
					{ctor: '[]'},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('command-name'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('command-desc'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
		...
		},
		{
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Minimal browser based IRC client connecting\n                       over a websocket proxy backend.'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$html$Html$p,
						{ctor: '[]'},
						_user$project$View$linkifyLine('source: https://github.com/erik/rain')),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('01 setup'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('02 supported commands'),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
...
var _user$project$View$view = function (model) {
	...
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$View$viewBufferList(model),
			_1: {
				ctor: '::',
				_0: chatView,
				_1: {ctor: '[]'}
				...
				A2(
					...
					function (line) {
						return A2(
							_user$project$Update$ModifyServer,
							serverName,
							_user$project$Update$ReceiveRawLine(line));
					},
					A2(
						_elm_lang$core$List$filter,
						function (_p0) {
